...
PRED_DIRS=(
  # "/PHShome/yl535/project/python/sam_3d/benchmark_sam3d/Hunyuan3D-2/results_hunyuan3d_AeroPath/lungs_${SLICE_AXIS}/"
  # "/PHShome/yl535/project/python/sam_3d/benchmark_sam3d/Hunyuan3D-2/results_hunyuan3d_BTCV/axis_${SLICE_AXIS}/"
  # "/PHShome/yl535/project/python/sam_3d/benchmark_sam3d/Hunyuan3D-2/results_hunyuan3d_MSD_Brain/axis_${SLICE_AXIS}/"
  # "/PHShome/yl535/project/python/sam_3d/benchmark_sam3d/Hunyuan3D-2/results_hunyuan3d_MSD_Liver/axis_${SLICE_AXIS}/"
  # "/PHShome/yl535/project/python/sam_3d/benchmark_sam3d/Hunyuan3D-2/results_hunyuan3d_MSD_Lung/axis_${SLICE_AXIS}/"
  "/PHShome/yl535/project/python/sam_3d/benchmark_sam3d/Hunyuan3D-2/results_hunyuan3d_duke_cspine/axis_${SLICE_AXIS}/"
  # "/PHShome/yl535/project/python/sam_3d/benchmark_sam3d/Hunyuan3D-2/results_hunyuan3d_AbdomenCT1K/axis_${SLICE_AXIS}/"
)

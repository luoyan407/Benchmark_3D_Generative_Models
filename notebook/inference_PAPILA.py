...
input_contour = f"/PHShome/yl535/project/python/datasets/PAPILA/ExpertsSegmentations/Contours/RET002OD_{type}_exp1.txt"
output_dir = f"/shared/ssd_28T/home/yl535/project/python/sam_3d/sam-3d-objects/results/gaussians/"
...
output["gs"].save_ply(os.path.join(output_dir, f"{base_name}_{type}.ply"))
...
# save video as gif
imageio.mimsave(
    os.path.join(output_dir, f"{base_name}_{type}.gif"),
    video,
    format="GIF",
